...
HD_PWD='C:/Users/marko/Documents/MeteorDestroyer/MeteorDestroyerSystem/MeteorDestroyerSystem.runs/hdmi_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_ila_0_0.tcl
