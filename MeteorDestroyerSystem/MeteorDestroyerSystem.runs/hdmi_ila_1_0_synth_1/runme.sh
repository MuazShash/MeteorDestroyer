...
HD_PWD='C:/Users/Muaz/Downloads/hw/hw.runs/hdmi_ila_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_ila_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_ila_1_0.tcl
