...
HD_PWD='C:/Users/marko/Documents/MeteorDestroyer/MeteorDestroyerSystem/MeteorDestroyerSystem.runs/hdmi_xbar_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_xbar_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_xbar_3.tcl
