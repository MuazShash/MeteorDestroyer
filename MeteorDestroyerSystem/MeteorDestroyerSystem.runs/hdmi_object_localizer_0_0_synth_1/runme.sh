...
HD_PWD='C:/Users/Muaz/Downloads/hw/hw.runs/hdmi_object_localizer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_object_localizer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_object_localizer_0_0.tcl
