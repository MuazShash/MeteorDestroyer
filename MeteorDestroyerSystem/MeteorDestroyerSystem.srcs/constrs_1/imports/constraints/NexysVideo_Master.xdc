...
set_property IOSTANDARD LVCMOS33 [get_ports {echo[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {echo[3]}]
...
set_property DRIVE 12 [get_ports {hdmi_rx_txen[0]}]
set_property PULLDOWN true [get_ports {echo[11]}]
set_property PULLDOWN true [get_ports {echo[10]}]
set_property PULLDOWN true [get_ports {echo[9]}]
set_property PULLDOWN true [get_ports {echo[8]}]
set_property PULLDOWN true [get_ports {echo[7]}]
set_property PULLDOWN true [get_ports {echo[6]}]
set_property PULLDOWN true [get_ports {echo[5]}]
set_property PULLDOWN true [get_ports {echo[4]}]
set_property PULLDOWN true [get_ports {echo[3]}]
set_property PULLDOWN true [get_ports {echo[2]}]
set_property PULLDOWN true [get_ports {echo[1]}]
set_property PULLDOWN true [get_ports {echo[0]}]
