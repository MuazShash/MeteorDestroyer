...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_ila_0_1.tcl
