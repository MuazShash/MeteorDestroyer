...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_lmb_bram_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_lmb_bram_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_lmb_bram_4.tcl
