...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_dlmb_bram_if_cntlr_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_dlmb_bram_if_cntlr_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_dlmb_bram_if_cntlr_4.tcl
