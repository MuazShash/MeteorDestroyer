...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_hcsr04_sensor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_hcsr04_sensor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_hcsr04_sensor_0_0.tcl
