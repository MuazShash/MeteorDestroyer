...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_xbar_2.tcl
