...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_rst_clk_wiz_0_100M_0.tcl
