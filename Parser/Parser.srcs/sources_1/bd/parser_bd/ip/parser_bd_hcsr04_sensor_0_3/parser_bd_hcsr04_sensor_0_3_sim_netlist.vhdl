...
--               c:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.srcs/sources_1/bd/parser_bd/ip/parser_bd_hcsr04_sensor_0_3/parser_bd_hcsr04_sensor_0_3_sim_netlist.vhdl
...
entity parser_bd_hcsr04_sensor_0_3_hcsr04_sensor is
  port (
  ...
  attribute ORIG_REF_NAME of parser_bd_hcsr04_sensor_0_3_hcsr04_sensor : entity is "hcsr04_sensor";
end parser_bd_hcsr04_sensor_0_3_hcsr04_sensor;

architecture STRUCTURE of parser_bd_hcsr04_sensor_0_3_hcsr04_sensor is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[4]_i_13\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_onehot_state[4]_i_14\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FSM_onehot_state[4]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_onehot_state[4]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_onehot_state[4]_i_8\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \counter[31]_i_5\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of trig_i_8 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of trig_i_9 : label is "soft_lutpair3";
begin
  trig <= \^trig\;
...
\FSM_onehot_state[4]_i_11\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\FSM_onehot_state[4]_i_14\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88808080"
    )
        port map (
...
\FSM_onehot_state[4]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => trig_i_3_n_0,
      I2 => counter(24),
      I3 => \FSM_onehot_state[4]_i_10_n_0\,
...
\FSM_onehot_state[4]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\counter[31]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFA8"
        ...
        port map (
      I0 => \FSM_onehot_state[4]_i_11_n_0\,
      I1 => counter(17),
...
\counter[31]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => counter(15),
      I2 => counter(16),
      I3 => \FSM_onehot_state[4]_i_14_n_0\,
      I4 => counter(11),
...
\echo_time[29]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
trig_i_4: unisim.vcomponents.LUT6
    generic map(
...
trig_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
trig_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity parser_bd_hcsr04_sensor_0_3 is
  port (
    clk : in STD_LOGIC;
    trig : out STD_LOGIC;
    echo : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of parser_bd_hcsr04_sensor_0_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of parser_bd_hcsr04_sensor_0_3 : entity is "parser_bd_hcsr04_sensor_0_3,hcsr04_sensor,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of parser_bd_hcsr04_sensor_0_3 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of parser_bd_hcsr04_sensor_0_3 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of parser_bd_hcsr04_sensor_0_3 : entity is "hcsr04_sensor,Vivado 2018.3";
end parser_bd_hcsr04_sensor_0_3;

architecture STRUCTURE of parser_bd_hcsr04_sensor_0_3 is
...
inst: entity work.parser_bd_hcsr04_sensor_0_3_hcsr04_sensor
     port map (
      clk => clk,
      distance_cm(4 downto 0) => \^distance_cm\(4 downto 0),
      echo => echo,
