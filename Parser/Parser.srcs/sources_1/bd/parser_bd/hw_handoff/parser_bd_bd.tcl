...
################################################################
# This is a generated script based on design: parser_bd
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net echo_0_1 [get_bd_ports echo_0] [get_bd_pins hcsr04_sensor_0/echo] [get_bd_pins ila_0/probe1]
  connect_bd_net -net hcsr04_sensor_0_distance_cm [get_bd_pins hcsr04_sensor_0/distance_cm] [get_bd_pins ila_0/probe0]
  connect_bd_net -net hcsr04_sensor_0_trig [get_bd_ports trig_0] [get_bd_pins hcsr04_sensor_0/trig] [get_bd_pins ila_0/probe2]
