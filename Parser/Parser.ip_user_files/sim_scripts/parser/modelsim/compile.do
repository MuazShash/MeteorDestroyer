...
vlog -work xpm  -incr -mfcu -sv "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
...
vlog -work generic_baseblocks_v2_1_0  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_26  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/0a3f/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_7  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
...
vlog -work axi_data_fifo_v2_1_25  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/5390/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_27  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/3fa0/hdl/axi_crossbar_v2_1_vl_rfs.v" \

vlog -work xil_defaultlib  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
...
vcom -work xil_defaultlib  -93 \
"../../../bd/parser/ip/parser_microblaze_0_2/sim/parser_microblaze_0_2.vhd" \

vcom -work lmb_v10_v3_0_12  -93 \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/cd1d/hdl/lmb_v10_v3_0_vh_rfs.vhd" \

vcom -work xil_defaultlib  -93 \
"../../../bd/parser/ip/parser_dlmb_v10_5/sim/parser_dlmb_v10_5.vhd" \
"../../../bd/parser/ip/parser_ilmb_v10_5/sim/parser_ilmb_v10_5.vhd" \

vcom -work lmb_bram_if_cntlr_v4_0_21  -93 \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/a177/hdl/lmb_bram_if_cntlr_v4_0_vh_rfs.vhd" \

vcom -work xil_defaultlib  -93 \
"../../../bd/parser/ip/parser_dlmb_bram_if_cntlr_5/sim/parser_dlmb_bram_if_cntlr_5.vhd" \
"../../../bd/parser/ip/parser_ilmb_bram_if_cntlr_5/sim/parser_ilmb_bram_if_cntlr_5.vhd" \

vlog -work blk_mem_gen_v8_4_5  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/25a8/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib  -incr -mfcu "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../bd/parser/ip/parser_lmb_bram_5/sim/parser_lmb_bram_5.v" \

vcom -work mdm_v3_2_23  -93 \
"../../../../Parser.gen/sources_1/bd/parser/ipshared/b8f4/hdl/mdm_v3_2_vh_rfs.vhd" \

vcom -work xil_defaultlib  -93 \
"../../../bd/parser/ip/parser_mdm_1_5/sim/parser_mdm_1_5.vhd" \

vlog -work xil_defaultlib  -incr -mfcu -sv "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/ec67/hdl" "+incdir+../../../../Parser.gen/sources_1/bd/parser/ipshared/4e49" \
"../../../bd/parser/ipshared/8ec5/sensor_parser.sv" \
"../../../bd/parser/ipshared/8ec5/array_parser.sv" \
"../../../bd/parser/ip/parser_array_parser_0_0/sim/parser_array_parser_0_0.sv" \
"../../../bd/parser/ipshared/14bd/src/filter.sv" \
"../../../bd/parser/ipshared/14bd/src/min.sv" \
"../../../bd/parser/ipshared/14bd/src/mult2.sv" \
"../../../bd/parser/ipshared/14bd/src/p2s.sv" \
"../../../bd/parser/ipshared/14bd/src/object_localization.sv" \
